...
def HDP(corpus, n_topic):
    ...
    word_distributions = distributions.word_distribution(model=hdp_model, n_topic=n_topic)
    ...
    doc_dist = distributions.lsi_doc_distribution(n_topic=topic_number, doc_number=doc_number, model=hdp_model, corpus=corpus)
